...
namespace CRMLearning.Plugins.Entities
{
	...
	public partial class new_invoice : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CRMLearning.Plugins.Entities.new_invoiceState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CRMLearning.Plugins.Entities.new_invoiceState)(System.Enum.ToObject(typeof(CRMLearning.Plugins.Entities.new_invoiceState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CRMLearning.Plugins.Entities.new_agreement new_new_agreement_new_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CRMLearning.Plugins.Entities.new_agreement>("new_new_agreement_new_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("new_new_agreement_new_invoice_dogovorid");
				this.SetRelatedEntity<CRMLearning.Plugins.Entities.new_agreement>("new_new_agreement_new_invoice_dogovorid", null, value);
