...
namespace CRMLearning.Workflows.Entities
{
	...
	public partial class new_agreement : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CRMLearning.Workflows.Entities.new_agreementState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CRMLearning.Workflows.Entities.new_agreementState)(System.Enum.ToObject(typeof(CRMLearning.Workflows.Entities.new_agreementState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CRMLearning.Workflows.Entities.new_invoice> new_new_agreement_new_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CRMLearning.Workflows.Entities.new_invoice>("new_new_agreement_new_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("new_new_agreement_new_invoice_dogovorid");
				this.SetRelatedEntities<CRMLearning.Workflows.Entities.new_invoice>("new_new_agreement_new_invoice_dogovorid", null, value);
